...
public class RouteInfoManager {
    ...
    //  topic对应的队列数据 消息发送时根据路由表进行负载均衡
    private final HashMap<String/* topic */, List<QueueData>> topicQueueTable;
    private final HashMap<String/* brokerName */, BrokerData> brokerAddrTable;
    //  成员变量全局唯一，在调用registerBroker时会把要注册的broker对象放入对应集群的set集合中
    ...
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                ...
                //  将当前broker放入全局变量clusterAddrTable对应的集群中
                ...
                if (null == brokerData) {
                    registerFirst = true;
                    //  第三个参数是brokerAddrs，是brokerId对应上brokerAddr的table
                    brokerData = new BrokerData(clusterName, brokerName, new HashMap<Long, String>());
                    //  维护了一个broker的kv，brokerData维护了集群名，地址
                    this.brokerAddrTable.put(brokerName, brokerData);
                }
                //  拿到broker对应的broker地址，实际上这里面的brokerAddr是没有值的
